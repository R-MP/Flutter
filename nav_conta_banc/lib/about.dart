...
class About extends StatelessWidget {
  ...
  About({required this.abName, required this.abAge, required this.abSex, required this.abSchl,
         required this.abCurrent, required this.abCheck});
    ...
    return SingleChildScrollView(
      child: Container(
        child: Column(
          ...
          txt('Limite de Credito: R\$$abCurrent', 20, Colors.black, FontWeight.bold),
